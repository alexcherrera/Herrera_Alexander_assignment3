...
//The Manager finishing the last two devices	
	...
	//Tablet Model 1 & 2
		...
		if (MustValue < reqSizeTabMd){
			console.log(compyName + " has a policy that in order to receive a case at no extra cost, \nthe size of the" + threePro[2] + " must be " + reqSizeTabMd + "and the " + valTaMd1N + " is " + MustValue + " inches.");
		} else {
